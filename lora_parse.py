...
try:
    while True: 
        ...
        if "Received: +RCV=" in line:
            ...
            rssi = data_values[9]  # RSSI 
            signal_to_noise = data_values[10]  # Signal 
            ...
            print(f"Logged data: Acceleration(X,Y,Z)=({acceleration_x},{acceleration_y},{acceleration_z}), Gyroscope(X,Y,Z)=({gyro_x},{gyro_y},{gyro_z}), Time={time_elapsed}, RSSI={rssi}, Signal={signal_to_noise}, ")   
            time.sleep(0.5)  
